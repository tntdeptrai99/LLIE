...
#include "llie_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_LLIE_MODEL_NAME          "llie"
#define AI_LLIE_ORIGIN_MODEL_NAME   "ghost_esp_dark_w12_m24_gain3_res035_plateau_score_best_monitor_qdq"

/******************************************************************************/
#define AI_LLIE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_LLIE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_LLIE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_LLIE_IN_NUM        (1)

AI_DEPRECATED
#define AI_LLIE_IN \
  ai_llie_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LLIE_IN_SIZE { \
  AI_LLIE_IN_1_SIZE, \
}
#define AI_LLIE_IN_SIZE_BYTES { \
  AI_LLIE_IN_1_SIZE_BYTES, \
}
#define AI_LLIE_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_LLIE_IN_1_HEIGHT      (96)
#define AI_LLIE_IN_1_WIDTH       (3)
#define AI_LLIE_IN_1_CHANNEL     (96)
#define AI_LLIE_IN_1_SIZE        (27648)
#define AI_LLIE_IN_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_LLIE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_LLIE_OUT \
  ai_llie_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LLIE_OUT_SIZE { \
  AI_LLIE_OUT_1_SIZE, \
}
#define AI_LLIE_OUT_SIZE_BYTES { \
  AI_LLIE_OUT_1_SIZE_BYTES, \
}
#define AI_LLIE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_LLIE_OUT_1_HEIGHT      (96)
#define AI_LLIE_OUT_1_WIDTH       (3)
#define AI_LLIE_OUT_1_CHANNEL     (96)
#define AI_LLIE_OUT_1_SIZE        (27648)
#define AI_LLIE_OUT_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_LLIE_N_NODES (55)
 ...
 */
AI_API_ENTRY
ai_error ai_llie_get_error(ai_handle network);
 ...
 */
AI_API_ENTRY
ai_handle ai_llie_destroy(ai_handle network);
 ...
 * @ref ai_llie_create. Both the activations memory buffer 
 ...
 * using @ref ai_llie_get_error
 */
AI_API_ENTRY
ai_bool ai_llie_init(
 ...
 */
AI_API_ENTRY
ai_error ai_llie_create_and_init(
 ...
 * header generated by the code generation tool. See AI_LLIE_*
 * defines into file @ref llie.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
