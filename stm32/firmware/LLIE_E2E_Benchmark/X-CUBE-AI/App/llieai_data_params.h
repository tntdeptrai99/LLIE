...
#define AI_LLIEAI_DATA_ACTIVATIONS_SIZES \
  { 392832, 138584, }
#define AI_LLIEAI_DATA_ACTIVATIONS_SIZE     (531416)
#define AI_LLIEAI_DATA_ACTIVATIONS_COUNT    (2)
#define AI_LLIEAI_DATA_ACTIVATION_1_SIZE    (392832)
#define AI_LLIEAI_DATA_ACTIVATION_2_SIZE    (138584)



#define AI_LLIEAI_DATA_WEIGHTS_SIZES \
  { 5924, }
#define AI_LLIEAI_DATA_WEIGHTS_SIZE         (5924)
#define AI_LLIEAI_DATA_WEIGHTS_COUNT        (1)
#define AI_LLIEAI_DATA_WEIGHT_1_SIZE        (5924)
...
extern ai_handle g_llieai_activations_table[2 + 2];
