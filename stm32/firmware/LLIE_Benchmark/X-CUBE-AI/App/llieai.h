...
/******************************************************************************/
#define AI_LLIEAI_MODEL_NAME          "llieai"
#define AI_LLIEAI_ORIGIN_MODEL_NAME   "ghost_esp_dark_w12_m24_gain3_res035_plateau_score_best_monitor_qdq"

/******************************************************************************/
#define AI_LLIEAI_ACTIVATIONS_ALIGNMENT   (4)
#define AI_LLIEAI_INPUTS_IN_ACTIVATIONS   (4)
#define AI_LLIEAI_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_LLIEAI_IN_NUM        (1)

AI_DEPRECATED
#define AI_LLIEAI_IN \
  ai_llieai_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LLIEAI_IN_SIZE { \
  AI_LLIEAI_IN_1_SIZE, \
}
#define AI_LLIEAI_IN_SIZE_BYTES { \
  AI_LLIEAI_IN_1_SIZE_BYTES, \
}
#define AI_LLIEAI_IN_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_LLIEAI_IN_1_HEIGHT      (96)
#define AI_LLIEAI_IN_1_WIDTH       (3)
#define AI_LLIEAI_IN_1_CHANNEL     (96)
#define AI_LLIEAI_IN_1_SIZE        (27648)
#define AI_LLIEAI_IN_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_LLIEAI_OUT_NUM       (1)

AI_DEPRECATED
#define AI_LLIEAI_OUT \
  ai_llieai_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LLIEAI_OUT_SIZE { \
  AI_LLIEAI_OUT_1_SIZE, \
}
#define AI_LLIEAI_OUT_SIZE_BYTES { \
  AI_LLIEAI_OUT_1_SIZE_BYTES, \
}
#define AI_LLIEAI_OUT_1_FORMAT      (AI_BUFFER_FORMAT_U8)
#define AI_LLIEAI_OUT_1_HEIGHT      (96)
#define AI_LLIEAI_OUT_1_WIDTH       (3)
#define AI_LLIEAI_OUT_1_CHANNEL     (96)
#define AI_LLIEAI_OUT_1_SIZE        (27648)
#define AI_LLIEAI_OUT_1_SIZE_BYTES  (27648)

/******************************************************************************/
#define AI_LLIEAI_N_NODES (55)
 ...
 * @ref ai_llieai_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_llieai_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_llieai_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_LLIEAI_*
 * defines into file @ref llieai.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
